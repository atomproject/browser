...
// option to the vulcanization must also be added to the array `excludes` in
// `removeBowerComponents` function.
let vulcan = new Vulcanize({
  excludes: [
    '_site/bower_components/t-component-panel/ace-element/ace/',
    '_site/components/custom-style.html'
  ],
  inlineScripts: true,
  inlineCss: true,
  stripComments: true
...
let vulcanCrisp = Q.async(function*() {
