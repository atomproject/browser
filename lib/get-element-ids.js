...
/**
 * Get travis id of the element repository
 * @param {Function} log    logger function
 * @param {Object}   config the config object
 * @return {Array}           the array of ids for each element
 */
let getElementIds = Q.async(function* (log, showBuildStatus, elements) {
  if (!showBuildStatus) {
